...
The [demo video](https://silvercipherr.github.io/Internet-CLock/demo.mp4) shows all 9 screens in action — clock, weather, stopwatch, Eid countdown, news scroll, forecast chart, T-Rex game, eye animations, and the Arch screen. Please download the video if github failed to load it.
...
```
For **Graphical** diagram: [Visit here.](https://silvercipherr.github.io/Internet-CLock/frontend/index.html)
